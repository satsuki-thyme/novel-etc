...
検索: (?=odA|key|li1|li2|bGr|inf|episode: \d+|summary)

### 統合プロット

検索: (?=(alice|leona|myria) (odA|bGr|li\d)|integ (gDs|lDs|odA|odR|ke|inf|env locat)|episode: \d+|summary)

### サブプロット

検索: (?=li\d|episode: \d+|summary)
...
検索: (?=- scene:|sn-descriptor|gis-item|int-item)
